...
const getFollowingPosts = async (req, res) => {
    ...
    try {
        ...
        if (followingUserIds.length === 0) {
            return res.status(200).json([]); // Return empty array if no following users
        }
...
module.exports = { createPost, validateCreatePost, getAllPost, likePost,getFollowingPosts, unlikePost, getComments, addComment, deletePost }