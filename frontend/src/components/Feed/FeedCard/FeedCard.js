        ...
        <div className="w-full mx-auto mb-6 bg-white p-4 rounded-lg">
            ...
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-x-3">
                    <Link to={`/profile/${feed.username}`} className="flex items-center">
                        <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-gray-300">
                            <img src={feed.profileImg} alt={feed.username} className="w-full h-full object-cover" />
                        </div>
                    </Link>
                    <div className="flex items-center gap-x-2">
                        <Link to={`/profile/${feed.username}`} className="text-black text-sm font-medium">
                            {feed.username}
                        </Link>
            ...
            <div className="w-full text-sm text-black font-thin mb-2">
                <Link to={`/profile/${feed.userId}`} className="text-black font-medium">
                    {feed.username}
                </Link> {feed.caption}
            </div>
            {/* Comment Count */}
