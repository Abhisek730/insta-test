        ...
        <div className="w-full mx-auto mb-6 bg-white p-4 rounded-lg">
            ...
            <div className="w-full flex iteme-center justify-between border-b border-gray-300 pt-2">
                <input type="text" value={newComment}
                    onChange={(e) => setNewComment(e.target.value)} className="w-full bg-transparent border-none outline-none text-sm text-gray-600 py-2" placeholder="Add a Comment ...." />
                <div className="text-black">
                    <button onClick={handleAddComment} className="ml-2 bg-blue-500 text-white py-1 px-1 text-sm rounded">
                        Post
                    </button>
                </div>
            </div>
